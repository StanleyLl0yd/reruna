...
object GameRules {
    ...
    const val STARTING_SPARKS = 3
    const val MAX_SPARKS = 4
    const val SPARK_RAMP_INTERVAL = 48

    const val ENTROPY_MAX = 100
    const val STARTING_ENTROPY_GAIN = 2
    const val ENTROPY_TURN_RAMP_INTERVAL = 64
    const val ENTROPY_RERUN_RAMP_DIVISOR = 2
